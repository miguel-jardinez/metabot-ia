...
const formatDuration = (second: number) => humanizeDuration(second * 1000, {
  largest: 1,
  round: true,
  units: ["h", "m", "s"]
});
...
const statusColorMap = {
  ...
  completed: "bg-esmerald-500/20 text-esmerald-800 border-esmerald-800/5",
  processing: "bg-gray-300/20 text-gray-800 border-gray-800/5",
  cancelled: "bg-rose-500/20 text-rose-800 border-yellow-800/5"
};
